...
# Add the Toy model
# If you don’t have your Toy model above your Cat model in models.py, 
# you’ll need to move it there now. This will correct any toy not defined server errors.
